export const translations = {
  en: {
    ...
    shortDescriptionMaxLength: 'Short description must not exceed 20 characters',
  ...
  ua: {
    ...
    shortDescriptionMaxLength: 'Короткий опис повинен містити не більше 20 символів',
