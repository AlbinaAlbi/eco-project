export const translations = {
  en: {
    ...
    forestArea: 'Forest area restored',
    damagedZones: 'Damaged zones rehabilitated through planting and soil care',
    months: 'months',
    ha: 'ha',
    ...
    projectNameMinLength: 'Project name must be at least 3 characters',
    shortDescriptionMinLength: 'Short description must be at least 20 characters',
    goalsDescription: 'Please describe the project goals in more detail',
    selectCategory: 'Select a category',
    validFundAmount: 'Enter a valid fundraising amount',
    selectProjectDuration: 'Select project duration',
    addProjectImage: 'Add a project image',
    errorForSending: 'Error sending',
    ...
    findAProjectTitle: 'Didn’t find a project?',
    findAProjectDescription: 'Create your own initiative and we’ll help you bring it to life',
  },
  ...
  ua: {
    ...
    projectsloading: 'Завантаження проєктів',
    volunteersInvolved: 'Залучені волонтери',
    forestArea: 'Відновлена лісова територія',
    damagedZones: 'Пошкоджені зони відновлені шляхом посадки рослин та догляду за ґрунтом',
    months: 'місяців',
    ha: 'год',
    nameMinLength: 'Імʼя повинно містити мінімум 2 символи',
    invalidEmail: 'Некоректний email',
    messageMinLength: 'Повідомлення повинно містити мінімум 10 символів',
    cityMinLength: 'Місто повинно містити мінімум 2 символи',
    projectNameMinLength: 'Назва проекту повинна містити мінімум 3 символи',
    shortDescriptionMinLength: 'Короткий опис повинен містити не меньше 20 символів',
    goalsDescription: 'Опишіть цілі проекту детальніше',
    selectCategory: 'Оберіть категорію',
    validFundAmount: 'Вкажіть коректну суму збору',
    selectProjectDuration: 'Оберіть тривалість проекту',
    addProjectImage: 'Додайте зображення проекту',
    errorForSending: 'Помилка при відправці',
    ...
    resultsList: {
      plantedTitle: 'Висаджені дерева',
      plantedDescription: {
        mobile: ['Місцеві види висаджені', 'на пошкоджених лісових', 'територіях Карпат'],
        tablet: ['Місцеві види висаджені на пошкоджених', 'лісових територіях Карпат'],
        desktop: ['Місцеві види висаджені на', 'пошкоджених лісових територіях Карпат'],
      },
      plantedCount: '12 450+',

      volunteersTitle: 'Активні волонтери',
      volunteersDescription: {
        mobile: [
          'Люди, які долучилися',
          'до проєктів з відновлення',
          'та громадських екоініціатив',
        ],
        tablet: ['Люди, які долучилися до проєктів', 'з відновлення та громадських екоініціатив'],
        desktop: ['Люди, які долучилися до проєктів', 'з відновлення та громадських екоініціатив'],
      },
      volunteersCount: '680+',

      landscapesTitle: 'Відновлені ландшафти',
      landscapesDescription: {
        mobile: ['Лісові зони, береги річок', 'та природні заповідники', 'повернуті до життя'],
        tablet: ['Лісові зони, береги річок та природні', 'заповідники, повернуті до життя'],
        desktop: ['Лісові зони, береги річок та природні', 'заповідники, повернуті до життя'],
      },
      landscapesCount: '37 га',

      collectedTitle: 'Зібрані відходи',
      collectedDescription: {
        mobile: ['Пластик, скло та змішані', 'відходи, прибрані', 'з природних територій'],
        tablet: ['Пластик, скло та змішані відходи', 'прибрані з природних територій'],
        desktop: ['Пластик, скло та змішані відходи', 'прибрані з природних територій'],
      },
      collectedCount: '24 т',

      reachedTitle: 'Охоплено людей',
      reachedDescription: {
        mobile: ['Через екоосвіту,', 'інформаційні кампанії', 'та громадські заходи'],
        tablet: ['Через екоосвіту, інформаційні', 'кампанії та громадські заходи'],
        desktop: ['Через екоосвіту, інформаційні', 'кампанії та громадські заходи'],
      },
      reachedCount: '15 000+',
    },
